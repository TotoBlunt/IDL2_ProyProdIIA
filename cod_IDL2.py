...
if upload_file is not None:
    try:
        ...
        st.write("\n###Para mejorar el logro del objetivo 'SI' en PesoFinal, concéntrate en mejorar las siguientes 5 variables principales:")
        cont = 0
        ...
        st.write('##Metricas de Evaluacion del "do Modelo:\n')
